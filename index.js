...
function changeQuote() {
    ...
    do {
        choosenIndex = Math.floor(Math.random() * quotes.length);
    } while (choosenIndex === previousIndex);

    previousIndex = choosenIndex;

    document.getElementById("quote").innerHTML = `"${quotes[choosenIndex].quote}"`;
    document.getElementById("author").innerHTML = `-- ${quotes[choosenIndex].writer}`;

    console.log(`${quotes[choosenIndex].quote} -- ${quotes[choosenIndex].writer}`);
}
